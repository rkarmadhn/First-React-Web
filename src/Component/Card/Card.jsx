...
export default function Card(props) {
  const {images, className = "bg-yellow-400" , classImage = "order-last", classTitle, classBody, classButton = "bg-black", title, body } = props;
  return (
    <div className={clsx(className, "md:flex block justify-center items-center rounded-3xl px-8 md:px-12 mx-auto py-4 my-8")}>
      <div className={clsx(classImage, "md:w-1/2 flex justify-center items-center")}>
